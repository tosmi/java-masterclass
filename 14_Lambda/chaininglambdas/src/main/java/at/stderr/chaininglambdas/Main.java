package at.stderr.chaininglambdas;
...
public class Main 
{
    public static void main( String[] args ) {
        ...
        Function<String, String> lastName = s -> s.concat(" Schmidbauer");
        ...
        // interim methods do not need to return String[]
        // only the final method
        Function<String, String[]> f0 = uCase
                .andThen(s -> s.concat(" Schmidbauer"))
                .andThen(s -> s.split(" "));

        System.out.println(f0.apply(name));
        System.out.println(
        ...
        Predicate<String> p1 = s -> s.equals("TONI");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Toni");
        ...
        // record is local to main() so direct field access possible
